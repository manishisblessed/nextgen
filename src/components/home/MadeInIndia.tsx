  ...
  return (
    <Section className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -left-32 top-1/2 h-[420px] w-[420px] -translate-y-1/2 rounded-full bg-[#FF9933]/10 blur-3xl" />
        <div className="absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/0 blur-3xl" />
        <div className="absolute -right-32 top-1/2 h-[420px] w-[420px] -translate-y-1/2 rounded-full bg-[#138808]/10 blur-3xl" />
      ...
      <Container>
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {indiaMissions.map((m) => (
            <article
              key={m.code}
              className="group relative overflow-hidden rounded-3xl border border-ink-100 bg-white p-6 transition hover:-translate-y-1 hover:border-brand-200 hover:shadow-soft"
            >
              <div className="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br from-brand-100 via-white to-accent-100 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
              <div className="flex items-center justify-between">
                <span className="font-display text-sm font-semibold text-brand-700">
                  {m.code}
                </span>
                <span className="inline-flex h-7 items-center gap-1 rounded-full bg-ink-50 px-2.5 text-[10px] font-semibold uppercase tracking-wider text-ink-600">
                  Mission · Bharat
                </span>
              </div>
        ...
        {/* Tricolour band */}
        <div className="mt-12 overflow-hidden rounded-2xl ring-1 ring-ink-100">
