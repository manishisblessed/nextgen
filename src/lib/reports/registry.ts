...
const SERVICE_CODES = [
  ...
  "TRAVEL_FLIGHT", "TRAVEL_HOTEL", "TRAVEL_BUS", "TRAVEL_TRAIN", "PAN_CARD", "INSURANCE", "POS", "QR",
];
...
export const REPORTS: Record<ReportType, ReportConfig> = {
  ...
  "bill-payment": {
    ...
    columns: [
      { key: "date", header: "Date", format: "datetime" },
      { key: "orderNo", header: "Order No.", format: "mono" },
      { key: "customerName", header: "Customer" },
      { key: "orderId", header: "Order ID", format: "mono" },
      { key: "bankLogo", header: "Logo", format: "avatar", align: "center" },
      { key: "paymentAmount", header: "Payment Amount", format: "money", align: "right" },
      { key: "charge", header: "Service Charge", format: "money", align: "right" },
      { key: "gst", header: "GST", format: "money", align: "right" },
      { key: "totalDebit", header: "Total Payment", format: "money", align: "right" },
      { key: "status", header: "Status", format: "badge" },
      { key: "mobile", header: "Mobile", format: "mono" },
      { key: "card", header: "Card No.", format: "mono" },
      { key: "referenceNo", header: "Reference No / Txn ID", format: "mono" },
    ],
    filters: {
      dateRange: true,
